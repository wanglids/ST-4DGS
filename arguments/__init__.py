...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_ani = 0.2
        self.lambda_loc = 0.001
        self.lambda_tem = 0.01

        self.coarse_neighbors = 200
        self.fine_neighbors = 200
        self.coarse_std = 1
        self.fine_std = 2
...
def get_combined_args(parser : ArgumentParser):
    ...
    try:
        cfgfilepath = os.path.join(args_cmdline.source_path,args_cmdline.model_path, "cfg_args")
